...
from custom_components.ecoflow_cloud_resilient.devices import BaseDevice, DiagnosticDevice

from custom_components.ecoflow_cloud_resilient.devices.internal import (
...
from custom_components.ecoflow_cloud_resilient.devices.public import (
