...
from custom_components.ecoflow_cloud_resilient.binary_sensor import MiscBinarySensorEntity
from custom_components.ecoflow_cloud_resilient.devices import BaseDevice, const
from custom_components.ecoflow_cloud_resilient.number import (
    ChargingPowerEntity,
    MaxBatteryLevelEntity,
    MinBatteryLevelEntity,
)
from custom_components.ecoflow_cloud_resilient.select import DictSelectEntity
...
class SmartHomePanel(BaseDevice):
    ...
    def configure(self, hass: HomeAssistant):
        ...
        self._hass = hass
        self._store: Store[dict] = Store(hass, 1, f"ecoflow_cloud_resilient.{self.device_info.sn}.timetask")
