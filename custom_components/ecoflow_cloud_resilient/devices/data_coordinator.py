...
class DeviceDataCoordinator(DataUpdateCoordinator[EcoflowBroadcastDataHolder]):
    ...
    def notify_data_changed(self) -> None:
        """Push fresh telemetry immediately instead of waiting for the next poll tick."""
        self.__last_broadcast = self.holder.last_received_time()
        self.async_set_updated_data(EcoflowBroadcastDataHolder(self.holder, True))
