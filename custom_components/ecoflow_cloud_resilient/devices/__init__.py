...
from custom_components.ecoflow_cloud_resilient.api.message import JSONDict, JSONMessage, Message
from custom_components.ecoflow_cloud_resilient.device_data import DeviceData
from custom_components.ecoflow_cloud_resilient.devices.data_holder import EcoflowDataHolder, PreparedData
from custom_components.ecoflow_cloud_resilient.devices.data_coordinator import DeviceDataCoordinator
from custom_components.ecoflow_cloud_resilient.devices.status_tracker import StatusTracker
...
class BaseDevice(ABC):
    ...
    def update_data(self, raw_data: bytes, data_type: str) -> bool:
        ...
        if hasattr(self, "coordinator"):
            self.coordinator.notify_data_changed()
        return True
